...
2. **[mission-01.md](missions/mission-01.md)** - 새총 쏘기 (상세 예시)
...
### 🎯 반사신경/타이밍 (10개)
Mission 1-10: 새총 쏘기, 과일 자르기, 두더지 잡기, 타이밍 점프, 리듬 탭, 파워 게이지, 빠른 클릭, 반응 테스트, 공 받기, 화살표 돌진

### 🧩 퍼즐/인지 (8개)
Mission 11-18: 숫자 맞추기, 같은 그림 찾기, 순서 기억, 색깔 이름, 빠른 계산, 패턴 따라하기, 숨은 그림, 퍼즐 슬라이드

### 🏃 액션/수집 (7개)
Mission 19-25: 폭탄 해제, 장애물 피하기, 사다리 오르기, 미로 탈출, 별 수집, 점프 게임, 스피드 런
...
### missions/mission-01.md (예시 - 새총 쏘기)
- 게임 상세 설명
- 조작 방법 및 규칙
- 점수 시스템
- 난이도별 변화 표
